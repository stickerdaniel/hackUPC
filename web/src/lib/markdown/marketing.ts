...
export function renderLlmsTxt(origin: string): string {
	...
	return [
		'# Co-Pilot',
		'',
		'> Public marketing content for the Co-Pilot project.',
		'',
		'## Overview',
		'',
		'Co-Pilot is a digital twin and AI maintenance copilot for the HP Metal Jet S100 industrial 3D printer. This file only describes the public marketing pages.',
		'',
		'## Canonical Pages',
		'',
